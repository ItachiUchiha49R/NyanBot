...
const forder = { key : {fromMe: false,participant : "0@s.whatsapp.net", ...(from ? { remoteJid: "5214447000377-1624232428@g.us" } : {})},message: {orderMessage: {itemCount : 999999999,status: 1,surface : 1,message: `🥀𝐒𝐚𝐦𝐮𝟑𝟑𝟎 | 𝑁𝑦𝑎𝑛𝐵𝑜𝑡🍒`,orderTitle: 'Samu330',sellerJid: `𝐈𝐬𝐡𝐢𝐠𝐚𝐦𝐢𝗕𝗼𝘁🌱`,thumbnail: fs.readFileSync('./src/fake.jpg')}}}
...
"title": `➫𝐈𝐬𝐡𝐢𝐠𝐚𝐦𝐢 | 𝐈𝐬𝐡𝐢𝐠𝐚𝐦𝐢 𝐘 𝐄𝐥𝐢𝐬𝐬𝐚🔥❣️`,
"description": `${texto}`,
"currencyCode": '',
